...
export function MoveBadge({ move }: { move: MoveType }) {
  const color: Record<MoveType, string> = {
    transfer: 'var(--move-transfer)',
    expedite: 'var(--move-expedite)',
    substitute: 'var(--move-substitute)',
    markdown_hold: 'var(--muted-foreground)',
    reorder: 'var(--move-reorder)',
  };
  ...
  return (
    <span
      ...
      style={{
        ...
        boxShadow: `inset 0 0 0 1px color-mix(in srgb, ${c} 42%, transparent)`,
      }}
    >
      {labels[move]}
    </span>
