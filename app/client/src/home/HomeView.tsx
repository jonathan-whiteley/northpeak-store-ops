...
import { fetchActivity, fetchPositionSummary } from '@/lib/stores';
import type { ActivityEvent, PositionSummary } from '@/shared/types';
...
export function HomeView() {
  ...
  useEffect(() => {
    // Activity feed + module signals. All non-fatal (page still renders
    // without them). Logged for dev debugging.
    const reload = () => {
