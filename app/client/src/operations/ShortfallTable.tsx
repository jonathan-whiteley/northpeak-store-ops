      ...
      <td className="px-4 py-2">
        {r.liveMoveType ? (
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-semibold uppercase tracking-wider text-[var(--warning-subtle-foreground)] bg-[var(--warning-subtle)] rounded-full px-2 py-0.5">
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex flex-col items-end gap-1 shrink-0">
          {r.liveMoveType ? (
            <>
              <span className="text-[10px] font-semibold uppercase tracking-wider text-[var(--warning-subtle-foreground)] bg-[var(--warning-subtle)] rounded-full px-2 py-0.5 whitespace-nowrap">
                Recovery
              </span>
              <MoveBadge move={r.liveMoveType} />
            </>
