    ...
    <div className={`flex ${s.gap}`}>
      ...
      <div className="flex-1 min-w-0">
        {content ? (
          <>
            <div
              className={`prose prose-sm prose-invert max-w-none ${s.body} [&>*:first-child]:mt-0 [&>*:last-child]:mb-0 [&>p]:leading-relaxed [&_table]:my-3 [&_th]:bg-muted [&_th]:font-semibold [&_code]:font-mono`}
            >
        ...
        {canceled && !streaming && (
          <div className={`rounded-${variant === 'full' ? 'lg' : 'md'} border border-[var(--warning)]/40 bg-[var(--warning)]/10 ${s.errorPad} ${s.errorText} text-[var(--warning-subtle-foreground)] mt-2`}>
